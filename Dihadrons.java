...
//        else if (variables.xF1()<0.0 || variables.xF2()<0.0) { return false; } 
	...
	z2 = lv_p2.e()/lv_q.e();
        ...
        LorentzVector lv_p_Breit = new LorentzVector(lv_p); lv_p_gN.boost(BreitBoost);
...
//                (lv_p1_COM.vect().mag()*lv_p_gN.vect().mag()));
        ...
        // this should be cross checked... old code had dihadron in lab frame I think
        // should be p1 in dihadron rest frame and p in gamma*-nucleon frame
        ...
        vecH.setMagThetaPhi(lv_p2_gN.vect().mag()/z2, lv_p2_gN.vect().theta(), 
                lv_p2_gN.vect().phi());
        Vector3 vecH1 = new Vector3();
        vecH1.setMagThetaPhi(lv_p1_gN.vect().mag(), lv_p1_gN.vect().theta(), 
                lv_p1_gN.vect().phi());
        Vector3 vecH2 = new Vector3();
        vecH2.setMagThetaPhi(lv_p2_gN.vect().mag(), lv_p2_gN.vect().theta(), 
                lv_p2_gN.vect().phi());
        Vector3 vecR = new Vector3(lv_p1_gN.vect()); // not R yet
        vecR.setMagThetaPhi(lv_p1_gN.vect().mag()/z1, lv_p1_gN.vect().theta(), 
                lv_p1_gN.vect().phi());
    ...
    public double Delta_eta() { return Double.valueOf(Math.round((eta1-eta2)*100000))/100000; }// returns Delta_eta, 
